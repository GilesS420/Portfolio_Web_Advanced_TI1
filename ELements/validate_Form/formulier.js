...
document
  ...
  .addEventListener("click", function (event) {
    ...
    saveToLocalStorage(name, age, postcode); // Opslaan in lokale opslag
...
document
  ...
  .addEventListener("click", async function (event) {
    ...
    try {
      ...
      console.error(
        "Er is een probleem opgetreden tijdens het verzenden naar de database:",
        error
      );
      alert(
        "Er is een probleem opgetreden tijdens het verzenden naar de database."
